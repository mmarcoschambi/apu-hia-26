...
### REQ-1: Reconciliación de Pipeline y Baseline
...
### REQ-2: Memoria de Gobernanza Activa y Segura
...
#### Scenario: Recuperación y validación de Memoria
...
### REQ-3: Playbook Pragmático y Estricto
...
#### Scenario: Matriz Determinista de "Code Smells"
...
### REQ-4: Puente Arquitectónico Codely-OpenSpec
...
#### Scenario: Redirección del Hand-off Funcional
