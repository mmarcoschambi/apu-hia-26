...
| **3. Pilares Empíricos** | Transparencia, Inspección y Adaptación | **[Scrum-Master]** p. 62 | *"Scrum se basa en el control de procesos empírico. El empirismo asegura que el conocimiento procede de la experiencia y de tomar decisiones basándose en lo que se conoce... Tres pilares sustentan toda implementación: Transparencia, Inspección y Adaptación."* | - **Transparencia:** Tablero público con WIP visible.<br>- **Inspección:** Dailies y Sprint Review.<br>- **Adaptación:** Retrospectiva y ajuste de backlog. |
| **4. Estructura de Roles** | Comprometidos vs Implicados (Fábula del Cerdo y la Gallina) | **[Scrum-Master]** pp. 33-36 | *"En un plato de huevos con jamón, la gallina está implicada, pero el cerdo está comprometido... El equipo scrum está formado por las personas comprometidas: Product Owner, Scrum Master y Developers."* | - **Product Owner:** Dueño del valor de negocio y priorización.<br>- **Scrum Master:** Facilitador, coach y removedor de impedimentos.<br>- **Developers:** Responsables técnicos de la construcción del incremento. |
| **5. Product Backlog y Épicas** | Artefacto Vivo y Emergente | **[Scrum-Master]** pp. 37-39; **[Cátedra-HIA]** p. 6 | *"El Product Backlog es una lista ordenada de todo lo que se conoce que es necesario en el producto. Es la única fuente de requisitos para cualquier cambio a realizarse... Nunca está completo. Es dinámico y evoluciona constantemente."* | Estructuración de 5 Épicas tecnológicas y 15 Historias de Usuario con formato estándar (*Como... Quiero... Para...*) priorizadas por valor de negocio. |
| **6. Criterios de Calidad** | Definición de Hecho (DoD) y Criterios de Aceptación | **[Scrum-Master]** pp. 42-43 | *"La Definición de Hecho (Definition of Done) es una comprensión compartida por el equipo de lo que significa que el trabajo esté completado... Si un ítem no cumple la DoD, no se puede presentar en la Review ni considerarse parte del Incremento."* | Cada Historia posee Criterios de Aceptación expresados en lenguaje Gherkin (*Dado/Cuando/Entonces*) y la DoD exige pruebas unitarias pasando, revisión por pares y despliegue en staging. |
| **7. Estimación Ágil** | Story Points, Planning Poker y Fibonacci | **[Scrum-Master]** pp. 54-57 | *"Los Story Points miden el esfuerzo relativo combinando volumen de trabajo, complejidad técnica e incertidumbre o riesgo... Se utiliza la serie de Fibonacci modificada (1, 2, 3, 5, 8, 13...) para evitar falsas precisiones."* | Estimación de las 15 Historias de Usuario mediante Planning Poker con baraja Fibonacci, totalizando 45 Story Points distribuidos entre los sprints. |
| **8. Evento: Daily Scrum** | Inspección Diaria y Timeboxing | **[Scrum-Master]** pp. 48-49 | *"La Daily Scrum es una reunión diaria de 15 minutos para el equipo de desarrollo... No es una reunión de reporte de estado al jefe, sino de sincronización entre pares respondiendo a tres preguntas: ¿Qué hice ayer? ¿Qué haré hoy? ¿Qué impedimentos tengo?"* | Registro formal de bitácora de Dailies (Días 1, 3, 5, 8, 10) con identificación temprana y resolución proactiva de 3 impedimentos técnicos críticos. |
| **9. Medición y Control** | Burndown Chart y Velocidad del Equipo | **[Scrum-Master]** pp. 57-59; **[Cátedra-HIA]** p. 5 | *"El Sprint Burndown Chart muestra la cantidad de trabajo pendiente a lo largo del tiempo del sprint... Permite visualizar de un vistazo si el equipo alcanzará el objetivo del sprint o si debe renegociar alcance con el PO."* | Gráfico de Burndown trazado día por día comparando la línea de quemado ideal vs real, demostrando la estabilización de velocidad del equipo. |
| **10. Evento: Sprint Review** | Inspección del Incremento y Demostración | **[Scrum-Master]** pp. 50-51 | *"El propósito de la Sprint Review es inspeccionar el resultado del sprint y determinar adaptaciones futuras. El equipo presenta el incremento potencialmente desplegable a los interesados y el PO explica qué se ha completado y qué no."* | Demostración funcional en vivo ante el Product Owner: aprovisionamiento de Proxmox, base de datos MySQL con persistencia, workflows de n8n y pipeline CI/CD activo. |
...
- **Compromiso:** Asumir metas de Sprint realistas basadas en la capacidad demostrada.
- **Coraje:** Reconocer impedimentos técnicos complejos y plantear cambios de arquitectura temprano.
- **Foco:** Trabajar exclusivamente en los ítems seleccionados para el Sprint Backlog activo.
...
### 3. La Fábula del Cerdo y la Gallina: Responsabilidad en el Equipo
El texto de Scrum Master (*Palacio, p. 33*) introduce la célebre analogía para distinguir el nivel de responsabilidad en proyectos ágiles:
> *"Una gallina y un cerdo están paseando y la gallina dice: '¡Oye! ¿Por qué no abrimos un restaurante?'. El cerdo responde: '¿Cómo lo llamaríamos?'. La gallina sugiere: '¿Qué tal Huevos con Jamón?'. El cerdo reflexiona y contesta: 'No, gracias. Yo estaría totalmente comprometido, pero tú sólo estarías implicada'."*

**Traducción al esquema de roles del TP:**
- Los **3 estudiantes del grupo** son los *comprometidos* (forman el Scrum Team: Product Owner, Scrum Master y Developers), asumiendo la autoría, código y defensa del proyecto.
- Los **docentes y evaluadores** actúan como *interesados / stakeholders* (implicados), proporcionando los requerimientos de la cátedra y evaluando el incremento de valor durante la defensa.

---

## 🔗 Conclusión Teórica de la Arquitectura
La integración metodológica implementada en el Trabajo Práctico no utiliza Scrum de manera superficial ni aislada. Se fundamenta en el marco normativo de la cátedra de Herramientas Informáticas Avanzadas y en los estándares internacionales de Scrum Manager®, asegurando una trazabilidad científica completa entre la teoría de gestión de proyectos y la implementación técnica de la plataforma tecnológica.
